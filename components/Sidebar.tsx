...
export const Sidebar = ({ editProfileHref, setIsOpen } : { editProfileHref: string, setIsOpen: any }) => {
        ...
        <aside id="cta-button-sidebar" className="w-64 h-full transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
            <div className="h-full px-3 py-4 overflow-y-auto bg-gray-950 flex flex-col justify-between">
                <ul className="space-y-2 font-medium">
                    <li>
                        <a className="flex items-center p-2 rounded-lg text-white bg-gray-700 group">
                    ...
                    {/* <li>
                        <a onClick={() => setIsOpen(true)} className="cursor-pointer flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            ...
                            <span className="flex-1 ms-3 whitespace-nowrap">New Box</span>
                        </a>
                    </li> */}
                    <li>
                        <a href={editProfileHref} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
